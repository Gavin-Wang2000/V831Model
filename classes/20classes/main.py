...
class VOC:
    mud_path = "./voc_int8.mud"
    labels = ["aeroplane","bicycle","bird","boat","bottle","bus","car","cat","chair","cow","diningtable","dog","horse","motorbike","person","pottedplant","sheep","sofa","train","tvmonitor"]
    anchors = [0.4165, 0.693 , 0.9765, 1.6065, 1.5855, 3.122 , 2.821 , 1.8515 ,4.72, 6.26]
    ...
    def process(self,input):
        ...
        boxes, probs = self.decoder.run(out, nms=0.3, threshold=0.6, img_size=(224,224))
